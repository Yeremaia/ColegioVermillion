  ...
  <body>
        ...
        <nav class="menu-all">
          ...
          <div class="conexion_usuario">
            ...
            <div class="nombre_abajo">
              <p>Nombre: <class="texto-main-datos"><?php echo $mostrarAdmin['nombre'].' '.$mostrarAdmin['apellido']; ?></p>
              <p>Usuario: Admin</p>
            </div>
          </div>
    ...
    <main>
      ...
      <div class="main-all">
        ...
        <h3 class="titulo-asistencia">Materias de <?php echo $asociar_curso['nombre_curso']?><img src="../../../imagenes/iconos/aula-gris.png" title="Editar materia de <?php echo $asociar_curso['nombre_curso']?>"></h3>

        <div class="imagen-icono-abajo">
          <a href="editarUnaMateria.php">
              <img src="../../../imagenes/iconos/editarMateria.png" alt="editar" title="Editar una Materia">
              <p>Editar una Materia</p>
          </a>
        </div>
        ...
        <ul class="materia-botones">
            ...
            <li class="navegacion-inicio"><a href="#">Editar</a></li>
            <li><a href="eliminarMateria.php">Eliminar</a></li>
            <li><a href="../AdminInicio.php"><img src="../../../imagenes/iconos/home.png" alt="inicio" title="Inicio" class="icono-home"></a></li>
        </ul>

        <form action="editarMateriaAdmin.php" method="get" class="boton-select">
      ...
      <div class="continer-table">
        ...
        <?php while($mostrar=mysqli_fetch_assoc($resultado)){?>
            <tr class="tr">
              ...
              <th> <a href="inicioEditarMateria.php?id=<?php echo $mostrar['id_horario']?>"><img src="../../../imagenes/iconos/editar.png"
              alt="editar" title="Editar" class="editar_materia"></a> </th>
            </tr>
<?php }?>
        </table>
