  ...
  <body>
    ...
    <header>
      ...
      <main>
        ...
        <h3 class="titulo-asistencia">Editar asistencias de <?php echo $asociar_curso['nombre_curso']?> <img src="../../../imagenes/iconos/editar.png" title="Editar Asistencia de <?php echo $asociar_curso['nombre_curso']?>"></h3>

        <ul class="materia-botones">
          <li><a href="../cursoAdmin.php">Visualizar</a></li>
          <li><a href="agregarAsistencia.php">Agregar</a></li>
          <li class="navegacion-inicio"><a href="#" class="color-navegacion">Editar</a></li>
        ...
        <form action="elegirEditarCursoAdmin.php" method="POST" class="boton-select">
      ...
      <div class="continer-table">
          ...
          <?php while($mostrar=mysqli_fetch_assoc($resultado_curso)){?>
                ...
                <tr class="campos-tabla-asistencia">
                    ...
                    <th><a href="editarCursoAdmin.php?id=<?php echo $mostrar['id_asistencia'];?>"><img src="../../../imagenes/iconos/editar.png" alt="editar" title="Editar" class="editar_calificacion"></a></th>
