...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-all">
        <h3 class="titulo-asistencia">Editar estudiantes de <?php echo $asociar_curso['nombre_curso']?> <img src="../../../imagenes/iconos/lapiz-gris.png" title="Editar estudiante de <?php echo $asociar_curso['nombre_curso']?>"></h3>
        ...
        <ul class="materia-botones">
          ...
          <li><a href="elegirEliminarEstudiante.php">Eliminar</a></li>
          <li><a href="../AdminInicio.php"><img src="../../../imagenes/iconos/home.png" alt="inicio" title="Inicio" class="icono-home"></a></li>
        </ul>

        <form action="elegirEditarEstudiante.php" method="POST" class="boton-select">
        ...
        <table id='tabla-estudiantes'>
          ...
          <?php while($mostrar=mysqli_fetch_assoc($resultado_estudiante)){?>
            <tr>
                ...
                <td><a href="editarEstudiante.php?id=<?php echo $mostrar['id_estudiante'];?>&curso=<?php echo $curso;?>"><img src="../../../imagenes/iconos/editar.png" alt="editar" title="Editar <?php echo $mostrar['nombre'].' '.$mostrar['apellido']; ?>" class="editar_estudiante"></a></td>
