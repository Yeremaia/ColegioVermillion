...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-all">
        <h3 class="titulo-asistencia">Editar profesores <img src="../../../imagenes/iconos/lapiz-gris.png" title="Editar profesor"></h3>
        ...
        <ul class="materia-botones">
          ...
          <li><a href="elegirEliminarProfesor.php">Eliminar</a></li>
        ...
        ?>
          ...
          <?php while ($mostrar = mysqli_fetch_assoc($conectar)) {?>
            <tr>
              ...
              <td><a href="editarProfesores.php?id=<?php echo $mostrar['id_profesor'];?>"><img src="../../../imagenes/iconos/editar.png" alt="editar" title="Editar <?php echo $mostrar['nombre'].' '.$mostrar['apellido']; ?>" class="editar_profesor"></a></td>
