...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Admin/Curso/Eliminar</title>
  </head>
  <body>
    ...
    <header>
      ...
      <main>
        ...
        <?php
          include("../../../conexionbd/conectar.php");
            $consulta = "SELECT DISTINCT id_curso,nombre_curso FROM curso ORDER BY id_curso";
            $resultado_curso = mysqli_query($conexionbd, $consulta);
        ?>

        <h3 class="titulo-asistencia">Eliminar curso<img src="../../../imagenes/iconos/borrar-gris.png" title="Eliminar Curso"></h3>

        <ul class="materia-botones">
          <li><a href="../cursoAdmin.php">Visualizar</a></li>
          <li><a href="agregarAsistencia.php">Agregar</a></li>
          <li><a href="elegirEditarCursoAdmin.php">Editar</a></li>
          <li class="navegacion-inicio"><a href="#" class="color-navegacion">Eliminar</a></li>
      ...
      <div class="continer-table">
          ...
          <table class="tabla-eliminar-curso">
              <tr class="tabla-asistencia-titulo">
                  <th class="constante-titulo">Curso</th>
                  <th></th>
              </tr>
          ...
          <?php while($mostrar=mysqli_fetch_assoc($resultado_curso)){?>
                ...
                <tr class="campos-tabla-asistencia">
                  ...
                  <td><a href="../procesar/eliminarCurso.php?id=<?php echo $mostrar['id_curso']; ?>"><img src="../../../imagenes/iconos/borrar.png" alt="borrar" title="Borrar <?php echo $mostrar['nombre_curso'];?>" class="editar_calificacion"> </a></td>
                </tr>
