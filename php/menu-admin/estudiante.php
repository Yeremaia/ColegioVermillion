...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <main>
      ...
      <div class="main-all">
        <h3 class="titulo-asistencia">Estudiantes de <?php echo $asociar_curso['nombre_curso']?> <img src="../../imagenes/iconos/ojo-gris.png" title="Ver estudiante de <?php echo $asociar_curso['nombre_curso']?>"></h3>

        <ul class="materia-botones">
          <li class="navegacion-inicio"><a href="#">Visualizar</a></li>
          <li><a href="accion/agregarEstudiante.php">Agregar</a></li>
          <li><a href="accion/elegirEditarEstudiante.php">Editar</a></li>
          <li><a href="accion/elegirEliminarEstudiante.php">Eliminar</a></li>
        ...
        <div class="imagen-icono-abajo">
          <a href="accion/agregarEstudiante.php">
            <img src="../../imagenes/iconos/agregar-usuario.png" alt="Agregar usuario" title="Agregar usuario"> <figcaption> Agregar Usuario</figcaption>
          </a>
        </div>
