...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Profesor/Calificaciones/Agregar</title>
  </head>
  <body>
    <header>
    ...
    <main>
      <?php echo $asignatura;?>
        ...
        <h3 class="titulo-asistencia">Estudiantes de <?php echo $asociar_curso['nombre_curso']?> <img src="../../../imagenes/iconos/agregar-gris.png" alt="agregar" title="Agregar Notas" class="editar_calificacion"></h3>

        <ul class="materia-botones">
          <li><a href="../profesorNota.php">Visualizar</a></li>
          <li class=""><a href="editarNotasProfesorElegir.php">Editar</a>
          <li class="navegacion-inicio"><a href="accion/agregarNotasProfesorElegir.php" class="color-navegacion">Agregar</a></li>
          <li><a href="../profesorInicio.php"><img src="../../../imagenes/iconos/home.png" alt="inicio" title="Inicio" class="icono-home"></a></li>
        </ul>

        <form action="agregarNotasProfesorElegir.php" method="get" class="boton-select">
      ...
      <table id='tabla-estudiantes'>
        ...
        <?php while($mostrar=mysqli_fetch_assoc($resultado_estudiante)){?>
          <tr>
              ...
              <td> <a href="agregarNotas.php?id=<?php echo $mostrar['id_estudiante'];?>"><img src="../../../imagenes/iconos/agregar-notas.png" alt="agregar" title="Agregar Notas de <?php echo $mostrar['nombre'];?>" class="editar_calificacion"></a> </td>
