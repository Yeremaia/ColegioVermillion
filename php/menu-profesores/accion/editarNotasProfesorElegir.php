...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Profesor/Calificaciones/Editar</title>
  </head>
  <body>
    <header>
    ...
    <main>
      <?php echo $asignatura;?>
        <h3 class="titulo-asistencia">Estudiantes de <?php echo $asociar_curso['nombre_curso']?> <img src="../../../imagenes/iconos/lapiz-gris.png" alt="editar" title="Editar" class="editar_calificacion"></h3>

        <ul class="materia-botones">
          <li><a href="../profesorNota.php">Visualizar</a></li>
          <li class="navegacion-inicio"><a href="#" class="color-navegacion">Editar</a>
          <li class=""><a href="agregarNotasProfesorElegir.php">Agregar</a></li>
          <li><a href="../profesorInicio.php"><img src="../../../imagenes/iconos/home.png" alt="inicio" title="Inicio" class="icono-home"></a></li>
        </ul>

        <form action="editarNotasProfesorElegir.php" method="get" class="boton-select">
      ...
      <table id='tabla-estudiantes'>
        ...
        <?php while($mostrar=mysqli_fetch_assoc($resultado_estudiante)){?>
          <tr>
              ...
              <td> <a href="editarNotasProfesor.php?id=<?php echo $mostrar['id_estudiante'];?>"><img src="../../../imagenes/iconos/editar.png" alt="editar" title="Editar <?php echo $mostrar['nombre'].' '.$mostrar['apellido']; ?>" class="editar_estudiante"></a> </td>
